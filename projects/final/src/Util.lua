...
--[[
    From point A to point B, calculate angle
]]
function Atan2(baseX, baseY, targetX, targetY)
    local angle = math.atan(math.abs(targetY - baseY) / math.abs(targetX - baseX)) 
    local up = (baseY < targetY)
    local right = (baseX < targetX)
